...
#
# Created: Thu Mar  2 16:42:31 2017
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verifyPushButton = QtGui.QPushButton(self.frame)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.verifyPushButton.setFont(font)
        self.verifyPushButton.setObjectName("verifyPushButton")
        self.horizontalLayout.addWidget(self.verifyPushButton)
        ...
        self.scanedGoodImageLabel.setMinimumSize(QtCore.QSize(0, 300))
        ...
        self.scanedGoodImageLabel.setScaledContents(True)
